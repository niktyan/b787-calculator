...
export interface ColorPalette {
  ...
  /**
   * 20%-alpha red, scoped to the CrosswindChart operational-envelope
   * dashed verticals (Polish-3) and reserved for future
   * "out-of-lookup" affordances. Distinct from `dangerSoft` (10–12%)
   * which is a background tint for inline error messages. Identical
   * in both themes. See `06-ui-spec.md` § Экран 4 → "Visualization · CG /
   * Crosswind chart" → Operational envelope.
   */
